-- MySQL database project: MODULE 4 Final project
...
SELECT * FROM Courses;
            ...
            -- TASKS TO WORK ON
-- TASK 1. Filter data using the WHERE clause and logical operataors;
...
CREATE TABLE DelivaryAddress (ID INT PRIMARY KEY,
Address VARCHAR(255) NOT NULL,
Type VARCHAR(100) NOT NULL DEFAULT "Private",
